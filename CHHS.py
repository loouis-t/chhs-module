...
class chhs():
    def __init__(self):
        ...
        self.mypath = "C:\\Users\\{}\\Desktop\\win_a_la_une".format(getpass.getuser())

        #Vérifier existence nv dossier windows a la une et le créer si NON
        if os.path.exists(self.mypath) == False:
            os.mkdir(self.mypath)

        print("IMAGES STOCKEES SUR LE BUREAU")
